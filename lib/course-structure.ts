 ...
 * 
 * This file defines the structure of all modules and lessons.
 * Each module contains multiple lessons that are displayed on separate pages.
 * 
 * Note: The structure can be customized via the admin panel, which saves to data/course-structure.json
 * This file serves as the default/fallback structure.
 */
...
export const courseStructure: Module[] = [
  ...
  },
  {
    ...
    description: 'Prepare the development environment and remove technical barriers.',
    estimatedTime: '2-3 hours',
    status: 'completed',
    lessons: [
      {
        id: '1',
        title: 'How Websites Function (Beginner Explanation)',
        description: 'Frontend, backend, database, hosting, explained simply.',
        estimatedTime: '30 minutes',
      },
      {
        id: '2',
        title: 'Creating and Setting Up GitHub',
        description: 'Account creation, repositories, and why version control matters.',
        estimatedTime: '30 minutes',
      },
      {
        id: '3',
        title: 'Installing and Configuring Cursor',
        description: 'Cursor installation, interface overview, and project setup.',
        estimatedTime: '45 minutes',
      },
      {
        id: '4',
        title: 'Using Cursor Effectively as a Beginner',
        description: 'How to prompt Cursor correctly and review generated code.',
        estimatedTime: '30 minutes',
      },
    ]
  },
  {
    id: '3',
    title: 'Planning the Website Structure',
    ...
    lessons: [
      {
        id: '1',
        title: 'Understanding a Booking Website User Journey',
        description: 'How users move from homepage to booking confirmation.',
        estimatedTime: '25 minutes',
      },
      {
        id: '2',
        title: 'Defining Website Pages and Content',
        description: 'Homepage, services, booking, and supporting pages.',
        estimatedTime: '25 minutes',
      },
      {
        id: '3',
        title: 'Choosing a Design Direction',
        description: 'Color palette, typography, spacing, and overall tone.',
        estimatedTime: '30 minutes',
      },
      {
        id: '4',
        title: 'Translating Design Decisions Into Cursor Prompts',
        description: 'How to describe design intent clearly to Cursor.',
        estimatedTime: '20 minutes',
      },
    ]
  },
  {
    ...
    description: 'Create a professional, responsive homepage using Cursor.',
    estimatedTime: '2-3 hours',
    status: 'completed',
    lessons: [
      {
        id: '1',
        title: 'What a Homepage Is Actually For',
        description: 'Understanding homepage purpose and structure before coding.',
        estimatedTime: '15 minutes',
      },
      {
        id: '2',
        title: 'Homepage Sections (The Non-Negotiables)',
        description: 'Hero section, services preview, trust indicators, and call-to-action.',
        estimatedTime: '20 minutes',
      },
      {
        id: '3',
        title: 'Setting the Website Vibe (Prompt Engineering That Actually Works)',
        description: 'How to describe emotion, audience, and constraints to AI.',
        estimatedTime: '30 minutes',
      },
      {
        id: '4',
        title: 'Generating the Homepage Code with Cursor',
        description: 'Step-by-step guide to creating the homepage layout.',
        estimatedTime: '30 minutes',
      },
      {
        id: '5',
        title: 'Refining Sections Using Targeted Prompts',
        description: 'Micro-prompts for improving individual sections.',
        estimatedTime: '25 minutes',
      },
      {
        id: '6',
        title: 'Common Beginner Errors (And How to Fix Them)',
        description: 'Too many colors, text too long, no call-to-action, and over-animation.',
        estimatedTime: '20 minutes',
      },
      {
        id: '7',
        title: 'Mobile Responsiveness Check',
        description: 'Ensuring the homepage works perfectly on mobile devices.',
        estimatedTime: '20 minutes',
      },
      {
        id: '8',
        title: 'When to Stop (This Matters)',
        description: 'Understanding when a homepage is done, not perfect.',
        estimatedTime: '10 minutes',
      },
    ]
  },
  ...
  },
  {
    ...
    description: 'Ensure a successful website launch.',
    estimatedTime: '2-3 hours',
    status: 'completed',
    lessons: [
      {
        ...
        description: 'Functionality, responsiveness, and performance.',
        estimatedTime: '40 minutes',
      },
      {
        id: '2',
        title: 'Debugging Errors Using Cursor',
        description: 'Reading and resolving errors with AI assistance.',
        estimatedTime: '30 minutes',
      },
      {
        id: '3',
      ...
      {
        id: '4',
        title: 'Post-Launch Improvements and Maintenance',
        description: 'Updating content and monitoring functionality.',
        estimatedTime: '20 minutes',
      },
    ]
  },
  {
    ...
    description: 'Launch confidently and learn how to grow and maintain your website long-term.',
    estimatedTime: '1.5 hours',
    status: 'completed',
    lessons: [
      {
      ...
      },
      {
        ...
        description: 'Using Cursor to understand, debug, and fix errors even as a non-developer.',
        estimatedTime: '25 minutes',
      },
      {
        id: '3',
