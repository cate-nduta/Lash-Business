...
const DEFAULT_TERMS: TermsDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'Deposits',
      body:
        'A deposit is required to secure every appointment. Deposits are strictly for securing your booking and cannot be refunded under any circumstance. The deposit is applied toward your final balance at checkout and cannot be transferred to another person.',
    },
    {
      id: 'cancellations',
