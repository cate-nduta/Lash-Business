...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      ...
      homeCallLocationId: rawHomeCallLocationId,
      homeCallLocationName: rawHomeCallLocationName,
    ...
    if (!isFree && (body.paymentStatus === 'pending_payment' || body.paymentMethod === 'paystack')) {
      ...
      const bookingData = {
        ...
        homeCallLocationId: visitTypeForBooking === 'home' ? rawHomeCallLocationId ?? null : null,
        homeCallLocationName: visitTypeForBooking === 'home' ? rawHomeCallLocationName ?? null : null,
