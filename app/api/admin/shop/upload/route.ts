...
const SUPABASE_BUCKET = process.env.SUPABASE_SHOP_BUCKET || 'shop-products'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const uploadsDir = join(process.cwd(), 'public', 'uploads', 'shop', 'products')
    ...
    const publicUrl = `/uploads/shop/products/${fileNameInfo.filename}`
