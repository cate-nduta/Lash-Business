...
export default function AdminDashboard() {
  ...
  const allMenuItems = [
    ...
    },
    {
      ...
      description: 'Edit course title, description, and overview details',
      href: '/admin/course-info',
      icon: '📋',
      ownerOnly: false,
    },
    {
      title: 'Course Structure',
      description: 'Edit modules, lessons, titles, and descriptions',
      href: '/admin/course-structure',
      icon: '📑',
      ownerOnly: false,
    },
    {
      title: 'Lesson Content',
      description: 'Edit lesson content and course materials',
      href: '/admin/lessons',
      icon: '📖',
      ownerOnly: false,
    },
    ...
    {
      title: 'LashDiary Labs',
      description: 'Manage consultation fee and pricing tiers for Labs',
      href: '/admin/labs',
      icon: '🔬',
      ownerOnly: false,
    },
    {
      title: 'Labs Businesses',
      description: 'View and help onboard Labs clients who have built their websites',
      href: '/admin/labs-businesses',
      icon: '🏢',
      ownerOnly: false,
    },
    {
      title: 'Labs Build Projects',
      description: 'Track build projects from payment to delivery',
      href: '/admin/labs-build-projects',
      icon: '🚀',
      ownerOnly: false,
    },
    {
      title: 'Labs Consultations',
      description: 'View all consultation requests from potential Labs clients',
      href: '/admin/labs-consultations',
      icon: '📋',
      ownerOnly: false,
    },
    {
    ...
    {
      title: 'Labs Support Tickets',
      description: 'View and respond to support tickets from Labs clients',
      href: '/admin/labs-tickets',
      icon: '🎫',
      ownerOnly: false,
    },
    {
    ...
    },
    {
      ...
      description: 'Configure payment links (Stripe, PayPal, etc.) and checkout instructions',
